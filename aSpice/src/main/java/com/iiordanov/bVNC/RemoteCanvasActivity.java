...
import com.iiordanov.bVNC.waishon.MenuTouchEventHandler;
...
public class RemoteCanvasActivity extends FragmentActivity implements OnKeyListener {
    ...
    private ImageButton menuButtonMenu;
    private ImageButton menuButtonKeyboard;
    ...
    void continueConnecting() {
        ...
        frameLayout = (FrameLayout) findViewById(R.id.canvas_framelayout);
        ...
        // MENÜ
        this.menuLinearLayout = (LinearLayout) findViewById(R.id.canvas_menu_layout);
        this.menuButtonMenu = (ImageButton) findViewById(R.id.canvas_menu_button_menu);
        this.menuButtonKeyboard = (ImageButton) findViewById(R.id.canvas_menu_button_keyboard);

        new MenuTouchEventHandler(getApplicationContext(), this.menuButtonMenu, this.menuLinearLayout, new OnClickListener() {
            @Override
        ...
        new MenuTouchEventHandler(getApplicationContext(), this.menuButtonKeyboard, this.menuLinearLayout, new OnClickListener() {
            @Override
            public void onClick(View view) {
                InputMethodManager inputMgr = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
                inputMgr.toggleSoftInput(0, 0);
    ...
    /**
     * WORKAROUND FÜR Tablets -> Warum?! KA
     */
    @Override
    ...
    void setModes() {
        ...
        ((ZoomScaling) canvas.scaling).resizeToFitScreen(RemoteCanvasActivity.this);
    }
