...
//        return mode == R.id.itemInputTouchPanZoomMouse;
    ...
    public void resizeToFitScreen(RemoteCanvasActivity remoteCanvasActivity) {
        // Canvas ermitteln
        RemoteCanvas canvas = remoteCanvasActivity.getCanvas();

        // Die kleinstmögliche Skalierung ermitteln
        ...
        Log.i("KST", "MINIMAL Scale" + canvas.getMinimumScale());
        minScaling = canvas.getMinimumScale();
        ...
        Log.i("KST", "OFFSET: " + canvasXOffset + " - " + canvasYOffset);
    }
